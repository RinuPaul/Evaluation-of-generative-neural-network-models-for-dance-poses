...
def main():
    ...
    args = SimpleNamespace(
        ...
        mocap_file=os.path.join(env_path, "merged_walk5.npz"),
        norm_mode="zscore",
        latent_size=32,
        num_embeddings=12,
        num_experts=6,
    ...
    for ep in range(1, args.num_epochs + 1):
        ...
        print("ep_recon_loss: {}".format(avg_ep_recon_loss))
        print("ep_kl_loss: {}".format(avg_ep_kl_loss))
        ...
        ### save every epoch
        torch.save(copy.deepcopy(pose_vae).cpu(), os.path.join(save_path, pose_vae_path[:-3] + '_' + str(ep) + '.pt'))
