...
class CustomMocapViewer:
    def __init__(
        ...
        self.characters = CustomMultiMocapCharacters(self._p, num_characters, self.colours)
    ...
    def duplicate_character(self):
        ...
        self.characters = CustomMultiMocapCharacters(bc, num_characters, colours)
...
class CustomMultiMocapCharacters:
